...
// v3.5: Applies config language to global i18n
...
// ═══════════════════════════════════════════════════════════════════════════
// GAME LAUNCH — no tray (v3.3 — user request: "don't want it in the tray")
// ═══════════════════════════════════════════════════════════════════════════

/**
 * Launches the game for a profile DELEGATING to ProfileManager (facade v3.1).
 *
 * v4.8 — MULTI-ACCOUNT: the manager STAYS VISIBLE when a game opens, so
...
function showSetupWindow(onDone) {
  ...
  setupWindow = new BrowserWindow({
    ...
    useContentSize: true, // v3.5: exact HTML geometry vs OS title bars
...
app.on('ready', function () {
  ...
  // ── v3.5: ONBOARDING — if firstBoot, show setup before manager ──
  if (config.firstBoot !== false) {
...
function _initManagerAndLaunch() {
  ...
  _logBanner();
  // v4.9.3 (Phase 2): flashPath is guaranteed non-null here — boot would
...
// v3.3: NO TRAY — when all windows close, the app exits.
